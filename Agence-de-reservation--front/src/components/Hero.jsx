...
import { useGuestSelector } from '../hooks/useGuestSelector';
...
const Hero = ({ onSearch }) => {
  ...
  useEffect(() => {
    if (pays && LOCATIONS[pays]) {
      setCities(LOCATIONS[pays]);
      setVille(''); // reset ville
    } else {
      setCities([]);
      setVille('');
    }
  ...
  const handleSearch = (e) => {
    e.preventDefault();
    onSearch({ ville, pays }); // Filtrer les hôtels
    navigate('/hotels');        // Optionnel si tu veux naviguer
  };
      ...
      <div className="container">
        ...
        <div className="row g-4 g-lg-5">
          ...
          <div className="col-lg-6 position-relative mb-4 mb-md-0">
            ...
            <div className="hstack gap-4 flex-wrap align-items-center">
              {/* Button */}
              <Link to="/hotels" className="btn btn-primary-soft mb-0">Discover Now</Link>
              {/* Story button */}
              <a 
          ...
          <div className="col-lg-6 position-relative">
            ...
            <div className="vstack gap-5 align-items-center position-absolute top-0 start-0 d-none d-md-flex mt-4 ms-n3">
              <img className="icon-lg shadow-lg border border-3 border-white rounded-circle" src="/assets/images/category/hotel/4by3/11.jpg" alt="avatar" />
        ...
        <div className="row mt-5">
          <div className="col-xl-10 position-relative mt-n3 mt-xl-n9">
            ...
            <form className="card shadow rounded-3 p-4 pe-md-5 pb-5 pb-md-4" onSubmit={handleSearch}>
        ...
        <div className="col-md-6">
          ...
          >
            <option value="">
              {pays ? 'Sélectionner une ville' : 'Choisir un pays d’abord'}
            </option>
            {cities.map((city) => (
          ...
          >
            ...
            {Object.keys(LOCATIONS).map((country) => (
              ...
              <div className="btn-position-md-middle mt-3">
                <button type="submit" className="icon-lg btn btn-round btn-primary mb-0">
                  <i className="bi bi-search fa-fw"></i> Rechercher
                </button>
              </div>
            </form>
          </div>
